...
//        CreatePostLikeResponseDto createPostLikeResponseDto = likeService.createPostLike(authorization.extractUserFromHeader(authorizationHeader), postId);
...
//        CreateCommentLikeResponseDto createCommentLikeResponseDto = likeService.createCommentLike(authorization.extractUserFromHeader(authorizationHeader), commentId);
